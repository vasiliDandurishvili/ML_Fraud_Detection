...
**არჩევანი:** Logistic Regression-ისთვის გამოვიყენე **0.75 threshold** (ბალანსი feature count-სა და მონაცემების ხარისხს შორის). Random Forest-სა და XGBoost-ისთვის ასევე იგივე ლოგიკით 0.75 threshold-ი დავტოვე, რადგან tree-based მოდელები კარგად უმკლავდებიან NaN-იან feature-ებს, მაგრამ უსარგებლო სვეტების შენარჩუნება მხოლოდ training-ის სიჩქარეს ამცირებს.
